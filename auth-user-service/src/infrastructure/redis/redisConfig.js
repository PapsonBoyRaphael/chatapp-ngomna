/**
 * Redis Configuration - Auth User Service
...
const redisConfig = {
  ...
  connectTimeout: parseInt(process.env.REDIS_CONNECTION_TIMEOUT, 10) || 5000,
  lazyConnect: true,
  maxRetriesPerRequest: parseInt(process.env.REDIS_MAX_RETRY_ATTEMPTS, 10) || 3,
